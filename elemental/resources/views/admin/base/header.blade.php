...
<head>
    ...
    <script defer src="{{ asset('codemirror/lib/codemirror.js') }}"></script>
    <script defer src="{{ asset('codemirror/mode/xml/xml.js') }}"></script>
    <script defer src="{{asset('js/dropzone.js')}}"></script>
