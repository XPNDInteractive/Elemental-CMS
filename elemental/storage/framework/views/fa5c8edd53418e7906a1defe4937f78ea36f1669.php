<?php $__env->startSection('content'); ?>
    <div class="row tools m-0 p-3 mb-4 align-items-center page-info">
        ...
        <a class="btn btn-primary ml-auto" href="<?php echo e(Route('posts_create')); ?>">
    ...
    <div class="list">
        ...
        <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           ...
           <a href="<?php echo e(Route('posts_update', ["id" => $page->id])); ?>" class="row">
                <div class=" bg-purple text-center py-3" style="width: 52px;">
                    <h6 class="text-white m-0"><?php echo e(strtoupper($page->title[0])); ?></h6>
                </div>
                 <div class="col-2">
                ...
                <div class="col-4">
                    <?php echo str_limit(strip_tags($page->content), 155); ?>

                </div>
                 <div class="col">
                    <?php echo e($page->users()->first()->name); ?>
