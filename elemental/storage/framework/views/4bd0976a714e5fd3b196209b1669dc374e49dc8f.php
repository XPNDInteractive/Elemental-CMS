<?php $__env->startSection('content'); ?>
    <div class="row tools m-0 p-3 mb-4 align-items-center page-info">
        ...
        <a class="btn btn-primary ml-auto" href="<?php echo e(Route('menu_create')); ?>">
    ...
    <div class="list">
        ...
        <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           ...
           <a href="<?php echo e(Route('menu_update', ["id" => $page->id])); ?>" class="row">
               ...
               <div class="col-2">
                    <?php echo e($page->path); ?>

                </div>
                <div class="col-2">
                    <?php echo e($page->weight); ?>
